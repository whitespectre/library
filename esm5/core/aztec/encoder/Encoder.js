...
var Encoder = /** @class */ (function () {
    ...
    Encoder.encode = function (data, minECCPercent, userSpecifiedLayers) {
        ...
        var eccBits = bits.getSize() * minECCPercent / 100 + 11;
        ...
        if (compact) {
            ...
            for (var i /*int*/ = 0, j = 0; i < baseMatrixSize / 2 - 1; i += 15, j += 16) {
                for (var k /*int*/ = (matrixSize / 2) & 1; k < matrixSize; k += 2) {
    ...
    Encoder.generateCheckWords = function (bitArray, totalBits, wordSize) {
        ...
        for (var _i = 0, _a = Array.from(messageWords); _i < _a.length; _i++) {
            var messageWord = _a[_i] /*: int*/;
