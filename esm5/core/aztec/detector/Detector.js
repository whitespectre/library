...
var CornerDetector_1 = require("../../common/detector/CornerDetector");
...
var Detector = /** @class */ (function () {
    ...
    Detector.prototype.detectMirror = function (isMirror) {
        ...
        // 5. Sample the grid
        var bits = this.sampleGrid(this.image, corners[(this.shift + 1) % 4], corners[(this.shift + 2) % 4], corners[(this.shift + 3) % 4], corners[this.shift % 4]);
     ...
     */
    Detector.prototype.getMatrixCornerPoints = function (pCenter, bullsEyeCorners, targetMatrixSize) {
        var maxX = 0.0;
        var minX = this.image.getWidth();
        bullsEyeCorners.forEach(function (bullsEyeCorner, idx, arr) {
        ...
        return (new CornerDetector_1.default(this.image, initSize, pCenter.getX(), pCenter.getY(), targetMatrixSize)).detect();
    };
    /**
     ...
     */
    Detector.prototype.isWhiteOrBlackRectangle = function (p1, p2, p3, p4, corr) {
